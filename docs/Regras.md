...
4. Toda chamada ao método chutar deve registrar a letra em letrasChutadas
5. Se a letra chutada não estiver contida na palavra, deve subtrair uma vida
6. Se a letra chutada estiver contida na palavra, deve ser substituida na "palavra" em sua respectiva posição. 
...
7. Caso a letra chutada esteja errada mas já foi chutada anteriormente, não deve substrair vida.
